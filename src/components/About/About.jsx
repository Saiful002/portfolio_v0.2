      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-4 border-t border-white/5">
        {statItems.map((stat, idx) => {
          ...
          return (
            <div
              key={stat.label}
              className="p-3.5 rounded-2xl bg-zinc-900/80 border border-white/10 flex flex-col items-center text-center gap-1 group hover:border-accent transition-all"
            >
              <Icon className="w-5 h-5 text-accent mb-1 group-hover:scale-110 transition-transform" />
